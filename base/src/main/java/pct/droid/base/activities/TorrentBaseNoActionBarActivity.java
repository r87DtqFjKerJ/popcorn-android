...
public abstract class TorrentBaseNoActionBarActivity extends Activity implements TorrentService.Listener {
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mService.addListener(TorrentBaseNoActionBarActivity.this);
//            mService.setCurrentActivity(TorrentBaseNoActionBarActivity.this);
